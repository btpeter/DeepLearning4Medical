...
TRAINED_MODEL_ADDRESS="/mnt/DeepLearning4Medical/trained_model/drag_design/160126/"+PARAM_TEST_OUTPUT_FILE_NAME
#TRAINED_MODEL_ADDRESS="/Users/peter/Documents/Work/DL4Medical_WorkTest/work_code/trained_model/drag_design/test1"


COST_STEP_OUTPUT="/mnt/DeepLearning4Medical/console_output/160126/"+PARAM_TEST_OUTPUT_FILE_NAME+".step_cost.txt"
COST_EPOCH_OUTPUT="/mnt/DeepLearning4Medical/console_output/160126/"+PARAM_TEST_OUTPUT_FILE_NAME+".epoch_cost.txt"
STATISTIC_RESULT_TEST="/mnt/DeepLearning4Medical/statistic_result/160126/"+PARAM_TEST_OUTPUT_FILE_NAME+"_test.txt"
STATISTIC_RESULT_TRAINING="/mnt/DeepLearning4Medical/statistic_result/160126/"+PARAM_TEST_OUTPUT_FILE_NAME+"_train.txt"
...
cost = cost + PARAM_COST_WEIGHT_STRENGTH * l2_loss
...
log_step_cost_object.write("Learning rate: "+str(PARAM_LEARNING_RATE)+"  Momentum:  "+str(PARAM_MOMENTUM)+"  Cost Weight Strength:  "+str(PARAM_COST_WEIGHT_STRENGTH)+"\r\n")
log_epoch_cost_object.write("Learning rate: "+str(PARAM_LEARNING_RATE)+"  Momentum:  "+str(PARAM_MOMENTUM)+"  Cost Weight Strength:  "+str(PARAM_COST_WEIGHT_STRENGTH)+"\r\n")
statistic_file_test_object.write("Learning rate: "+str(PARAM_LEARNING_RATE)+"  Momentum:  "+str(PARAM_MOMENTUM)+"  Cost Weight Strength:  "+str(PARAM_COST_WEIGHT_STRENGTH)+"\r\n")
statistic_file_train_object.write("Learning rate: "+str(PARAM_LEARNING_RATE)+"  Momentum:  "+str(PARAM_MOMENTUM)+"  Cost Weight Strength:  "+str(PARAM_COST_WEIGHT_STRENGTH)+"\r\n")
